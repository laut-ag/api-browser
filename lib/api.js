...
exports.stationsByGenre = exports.stationStartsWith = exports.stations = exports.allStations = exports.numLiveStations = exports.stationIsLive = exports.liveStations = exports.liveStationsRaw = exports.listeners = exports.allListeners = exports.hasStation = exports.stationNames = exports.relatedGenres = exports.relatedGenresRaw = exports.genresRaw = exports.genres = exports.hasLetter = exports.letters = exports.serverTime = exports.serverStatus = exports.isServerRunning = void 0;
...
var relatedGenresRaw =
/*#__PURE__*/
function () {
  var _ref8 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee8(genre) {
    var resp, selGen;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 2:
            ...
            return _context8.abrupt("return", selGen.related);
  ...
  return function relatedGenresRaw(_x2) {
...
exports.relatedGenresRaw = relatedGenresRaw;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 2:
            ...
            return _context9.abrupt("return", selGen.map(function (g) {
              return g.name;
            }));
...
var assignOptions = function assignOptions(options) {
  ...
  if (options.length === 3) {
    throw 'no 3 options allowed';
  }

  if (options.filter(function (o) {
    return typeof o !== 'number';
  }).length) {
    throw 'something isnt a number';
  } //let params = ''
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee19(_stations, options) {
    var cops, resp;
      ...
      while (1) {
        switch (_context19.prev = _context19.next) {
          case 0:
            cops = assignOptions(options);
            _context19.next = 3;
            return (0, _query.query)("stations/".concat(_stations), cops);
  ...
  return function stations(_x8, _x9) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee20(startw, options) {
    var cops, resp, _resp;
      ...
      while (1) {
        switch (_context20.prev = _context20.next) {
          ...
          case 4:
            ...
            return _context20.abrupt("return", resp.filter(function (s) {
          ...
          case 10:
            ...
            return _context20.abrupt("return", _resp);
  ...
  return function stationStartsWith(_x10, _x11) {
