...
export default class Station {
     ...
     */
    get twitterUrl() { return this.genData.third_parties.twitter.url }

    /**
     * The twitter name associated with the station
     * @returns {string} twitter handle
     */
    get twitterName() { return this.genData.third_parties.twitter.name }
     ...
     */
    get phonostarUrl() { return this.genData.third_parties.phonostar.url }

    /**
     * The URL of a station on radio.de
     * @return {string} radio.de url
     */
    get radiodeUrl() { return this.genData.third_parties.radiode.url }
